    ...
    TackModel.prototype.moveDistancePoint = function () {
        ...
        switch (this.direction) {
            case DIRECTION.UPPER:
                ...
                this.reactImg.apply(this, imgReact.UPPER);
                break;
            case DIRECTION.ALSO:
                distance[0] = Math.abs(this.distance[0] * this.moveVector[0]);
                this.reactImg.apply(this, imgReact.ALSO);
                break;
            case DIRECTION.LOWER:
                distance[1] = Math.abs(this.distance[1] * this.moveVector[1]);
                this.reactImg.apply(this, imgReact.LOWER);
                break;
            case DIRECTION.LEFT:
                distance[0] = -Math.abs(this.distance[0] * this.moveVector[0]);
                this.reactImg.apply(this, imgReact.LEFT);
                break;
        }
        return distance;
    };
